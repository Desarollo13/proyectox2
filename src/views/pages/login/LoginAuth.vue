<template>
  <div class="bg-light min-vh-100 d-flex align-items-center justify-content-center">
    <div class="card shadow-sm rounded-4 p-4 simple-login-card position-relative">
      <!-- (Opcional) botón volver -->
      <!-- <router-link to="/" class="btn btn-link p-0 position-absolute top-0 start-0 m-3">
